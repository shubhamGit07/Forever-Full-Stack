        ...
        <div className='border-t border-gray-200 pt-10 transition-opacity ease-in duration-500 opacity-100'>
...

                        {
                            productData.image.map((item, index) => (
                                <img
                                    ...
                                    src={item}
                                    key={index}
                                    className='w-[24%] sm:w-full sm:mb-3 flex-shrink-0 cursor-pointer border border-gray-200'
                                    alt=""
                                />
                            ))
                        }
...

                            {
                                productData.sizes.map((item, index) => (
                                    <button
                                        ...
                                        className={`border border-gray-200 py-2 px-4 bg-gray-100 ${item === size ? 'border-orange-500' : ''}`}
                                        key={index}
                                    >
                                        {item}
                                    </button>
            ...
            <div className='mt-20'>
                ...
                <div className='flex'>
                    ...
                    <p className='border border-gray-200 px-5 py-3 text-sm text-gray-1000'>
                        Reviews (122)
                    </p>
